...
function dTree(objName) {
	...
	this.icon = {
		root				: '../../Css/Third/dtree/img/base.gif',
		folder			: '../../Css/Third/dtree/img/folder.gif',
		folderOpen	: '../../Css/Third/dtree/img/folderopen.gif',
		node				: '../../Css/Third/dtree/img/page.gif',
		empty				: '../../Css/Third/dtree/img/empty.gif',
		line				: '../../Css/Third/dtree/img/line.gif',
		join				: '../../Css/Third/dtree/img/join.gif',
		joinBottom	: '../../Css/Third/dtree/img/joinbottom.gif',
		plus				: '../../Css/Third/dtree/img/plus.gif',
		plusBottom	: '../../Css/Third/dtree/img/plusbottom.gif',
		minus				: '../../Css/Third/dtree/img/minus.gif',
		minusBottom	: '../../Css/Third/dtree/img/minusbottom.gif',
		nlPlus			: '../../Css/Third/dtree/img/nolines_plus.gif',
		nlMinus			: '../../Css/Third/dtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
