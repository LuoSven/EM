...
namespace EM.Data.Repositories
{
    ...
    public class SystemAlertMessageRepo : RepositoryBase<EM_System_AlertMessage>, ISystemAlertMessageRepo
    {
        ...
        {
            var list =  DapperHelper.SqlQuery<SystemAlertMessageDTO>(@"select a.Id,a.MessagType, a.Message,a.CreateTime,case when c.RoleType=@admin then '系统管理员' else b.UserName end  as	Sender  from EM_System_AlertMessage a 
