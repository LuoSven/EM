...
namespace EM.Data.Repositories
{
    ...
    public interface IChargeCateRepo : IRepository<EM_Charge_Cate>
    {
        ...
        /// <returns></returns>
        List<KeyValueVM> GetList(int RoleTypeId, CateDropType CateListType, string cateIds);

        List<KeyValueVM> GetGroupList(int RoleTypeId, CateDropType CateListType, string cateIds);
